...
export default function Header() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-4 md:px-6 py-4 bg-white border-b border-gray-200 gap-6 ">
      {/* Left: Greeting */}
      <div>
      ...
      <div className="flex flex-wrap md:flex-nowrap items-center gap-3  pb-2">
